...
Please set in Streamlit Cloud Secrets:
...
"""
    ...
    try:
        ...
        # Optional health check – uncomment to verify connection
...
def get_service_supabase() -> Client:
    """Service role client – bypasses RLS (use only for admin/QR verification)"""
    url = st.secrets.get("SUPABASE_URL") or os.getenv("SUPABASE_URL")
...
# Global exports – use these in your code
