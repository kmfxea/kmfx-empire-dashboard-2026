# utils/styles.py
# =====================================================================
# KMFX EA - FULL CONSOLIDATED STYLES (v3.13 – All Titles Golden BG + Black Font Feb 28, 2026)
# Lahat ng title: golden background + black font (like ENTER buttons), top black font + emoji improved
# =====================================================================
...
def apply_global_styles(public: bool = True):
    ...
    <style>
        ...
        .main .block-container {{
            ...
            padding: 0.6rem 1.5rem 2rem !important;
        }}

        /* LAHAT NG TITLE - GOLDEN BACKGROUND + BLACK FONT (like ENTER buttons) */
        h1, h2, h3, h4, .title-golden, .gold-title {{
        ...
        h1 {{ font-size: clamp(3rem, 8vw, 5.5rem) !important; }}
        h2 {{ font-size: clamp(2rem, 5.5vw, 3.5rem) !important; }}
        h3 {{ font-size: clamp(1.6rem, 4.5vw, 2.4rem) !important; }}

        /* TOP HERO TITLES - BLACK FONT + EMOJI IMPROVED */
        .hero-title {{
        ...
        /* METRICS BOX - WHITE TEXT + CENTERED */
        .metrics-box {{
        ...
        /* GLASS CARDS, LOGIN BOX, TABS, SCROLLBAR, etc. - kept as is */
        .glass-card {{
